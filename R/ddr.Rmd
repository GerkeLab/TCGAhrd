...
```{r quick_figure, warning=FALSE, fig.pos="center", fig.cap=c("DDR scores by dominant ancestral populations and startified by cancer type."), fig.width=12, fig.height=12}
