...
**Created files:**
  ...
  * gene_and_hrd.RData and gene_and_hrd.txt - PanCancer gene expression data with scores information (`r length(intersect(substr(colnames(gene),1,15),hrd$patient_id))` overlapping patients only)
